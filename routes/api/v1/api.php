...
Route::group(['namespace' => 'Api\V1', 'middleware'=>['localization','react']], function () {
    ...
    Route::group(['prefix' => 'delivery-man'], function () {
        ...
        Route::group(['middleware'=>['dm.api']], function () {
            ...
            Route::post('make-collected-cash-payment-Deliveryman', 'DeliverymanController@make_payment')->name('make_payment-Deliveryman');
            Route::post('make-wallet-adjustment-Deliveryman', 'DeliverymanController@make_wallet_adjustment')->name('make_wallet_adjustment-Deliveryman');

            Route::get('wallet-payment-list-Deliveryman', 'DeliverymanController@wallet_payment_list')->name('wallet_payment_list-Deliveryman');
