                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        <div class="d-flex flex-wrap justify-content-between mb-3">
                                            ...
                                            <label
                                                ...
                                                <span
                                                    class="pl-2 switch--custom-label-text text-primary on text-uppercase">{{
                                                    translate('messages.on') }}</span>
                                                <span class="pl-2 switch--custom-label-text off text-uppercase">{{
                                                    translate('messages.off') }}</span>
                                            </label>
                                        </div>
                                        <textarea name="pending_message[]" class="form-control"
                                            placeholder="{{translate('Ex : Your order is successfully placed')}}">{{$opm['message']??''}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <textarea name="confirm_message[]" class="form-control"
                                            placeholder="{{translate('Ex : Your order is confirmed')}}">{{$ocm['message']??''}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        <div class="d-flex flex-wrap justify-content-between mb-3">
                                            ...
                                            <label
                                                ...
                                                <input type="checkbox" name="processing_status"
                                                    ...
                                                    class="toggle-switch-input" value="1" id="processing_status"
                                                    {{$oprm?($oprm['status']==1?'checked':''):''}}>
                                                <span class="toggle-switch-label text">
                                                    <span class="toggle-switch-indicator"></span>
                                                </span>
                                                <span
                                        ...
                                        <textarea name="processing_message[]" class="form-control"
                                            placeholder="{{translate('Ex : Your order is started for cooking')}}">{{$oprm['message']??''}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        <div class="d-flex flex-wrap justify-content-between mb-3">
                                            ...
                                            <label
                                                ...
                                                <input type="checkbox" name="order_handover_message_status"
                                                    ...
                                                    class="toggle-switch-input" value="1"
                                                    id="order_handover_message_status"
                                                    {{$ohm?($ohm['status']==1?'checked':''):''}}>
                                                <span class="toggle-switch-label text">
                                                    <span class="toggle-switch-indicator"></span>
                                                </span>
                                                <span
                                        ...
                                        <textarea name="order_handover_message[]" class="form-control"
                                            placeholder="{{translate('Ex : Delivery man is on the way')}}">{{$ohm['message']??''}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <textarea name="out_for_delivery_message[]" class="form-control"
                                            placeholder="{{translate('Ex : Your food is ready for delivery')}}">{{$ofdm['message']??''}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <textarea name="delivered_message[]" class="form-control"
                                            placeholder="{{translate('Ex : Your order is delivered')}}">{{$odm['message']??''}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <textarea name="delivery_boy_assign_message[]" class="form-control"
                                            placeholder="{{translate('Your order has been assigned to a delivery man')}}">{{$dbam['message']??''}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <textarea name="delivery_boy_delivered_message[]" class="form-control"
                                            placeholder="{{translate('Ex : Order delivered successfully')}}">{{$dbcm['message']??''}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <textarea name="order_cancled_message[]" class="form-control"
                                            placeholder="{{translate('Ex :  Order is canceled by your request')}}">{{$ocam['message']??''}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <textarea name="order_refunded_message[]" class="form-control"
                                            placeholder="{{translate('messages.Ex : Your refund request is successful')}}">{{$orm['message']??''}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        <div class="d-flex flex-wrap justify-content-between mb-3">
                                            ...
                                            <label
                                                ...
                                                <input type="checkbox" name="refund_request_canceled_status"
                                                    ...
                                                    id="refund_request_canceled"
                                                    {{$orcm?($orcm['status']==1?'checked':''):''}}>
                                                <span class="toggle-switch-label text">
                                                    <span class="toggle-switch-indicator"></span>
                                                </span>
                                                <span
                                        ...
                                        <textarea name="refund_request_canceled[]" class="form-control"
                                            placeholder="{{translate('messages.Ex : Your_order_refund_request_is_canceled')}}">{{$orcm['message']??''}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        <div class="d-flex flex-wrap justify-content-between mb-3">
                                            ...
                                            <label
                                                ...
                                                <input type="checkbox" name="offline_order_accept_message_status"
                                                    ...
                                                    id="offline_order_accept_message"
                                                    {{$ofrcm?($ofrcm['status']==1?'checked':''):''}}>
                                                <span class="toggle-switch-label text">
                                                    <span class="toggle-switch-indicator"></span>
                                                </span>
                                                <span
                                        ...
                                        <textarea name="offline_order_accept_message[]" class="form-control"
                                            placeholder="{{translate('messages.Ex : Your_offline_payment_is_accepted')}}">{{$ofrcm['message']??''}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        <div class="d-flex flex-wrap justify-content-between mb-3">
                                            ...
                                            <label
                                                ...
                                                <input type="checkbox" name="offline_order_deny_message_status"
                                                    ...
                                                    id="offline_order_deny_message"
                                                    {{$ofpdm?($ofpdm['status']==1?'checked':''):''}}>
                                                <span class="toggle-switch-label text">
                                                    <span class="toggle-switch-indicator"></span>
                                                </span>
                                                <span
                                        ...
                                        <textarea name="offline_order_deny_message[]" class="form-control"
                                            placeholder="{{translate('messages.Ex : Your_offline_payment_is_denided')}}">{{$ofpdm['message']??''}}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <textarea name="pending_message[]" class="form-control"
                                            placeholder="{{translate('Ex : Your order is successfully placed')}}">{!! (isset($translate) && isset($translate[$lang]))?$translate[$lang]['message']:' ' !!}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <textarea name="confirm_message[]" class="form-control"
                                            placeholder="{{translate('Ex : Your order is confirmed')}}">{!! (isset($translate_2) && isset($translate_2[$lang]))?$translate_2[$lang]['message']:' ' !!}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <textarea name="processing_message[]" class="form-control"
                                            placeholder="{{translate('Ex : Your order is started for cooking')}}">{!! (isset($translate_3) && isset($translate_3[$lang]))?$translate_3[$lang]['message']:' ' !!}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <textarea name="order_handover_message[]" class="form-control"
                                            placeholder="{{translate('Ex : Delivery man is on the way')}}">{!! (isset($translate_4) && isset($translate_4[$lang]))?$translate_4[$lang]['message']:' ' !!}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <textarea name="out_for_delivery_message[]" class="form-control"
                                            placeholder="{{translate('Ex : Your food is ready for delivery')}}">{!! (isset($translate_5) && isset($translate_5[$lang]))?$translate_5[$lang]['message']:' ' !!}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <textarea name="delivered_message[]" class="form-control"
                                            placeholder="{{translate('Ex : Your order is delivered')}}">{!! (isset($translate_6) && isset($translate_6[$lang]))?$translate_6[$lang]['message']:' ' !!}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <textarea name="delivery_boy_assign_message[]" class="form-control"
                                            placeholder="{{translate('Your order has been assigned to a delivery man')}}">{!! (isset($translate_7) && isset($translate_7[$lang]))?$translate_7[$lang]['message']:' ' !!}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <textarea name="delivery_boy_delivered_message[]" class="form-control"
                                            placeholder="{{translate('Ex : Order delivered successfully')}}">{!! (isset($translate_8) && isset($translate_8[$lang]))?$translate_8[$lang]['message']:' ' !!}</textarea>
                                    </div></textarea>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <textarea name="order_cancled_message[]" class="form-control"
                                            placeholder="{{translate('Ex :  Order is canceled by your request')}}">{!! (isset($translate_9) && isset($translate_9[$lang]))?$translate_9[$lang]['message']:' ' !!}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <textarea name="order_refunded_message[]" class="form-control"
                                            placeholder="{{translate('messages.Ex : Your refund request is successful')}}">{!! (isset($translate_10) && isset($translate_10[$lang]))?$translate_10[$lang]['message']:' ' !!}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <textarea name="refund_request_canceled[]" class="form-control"
                                            placeholder="{{translate('messages.Ex : Your_order_refund_request_is_canceled')}}">{!! (isset($translate_11) && isset($translate_11[$lang]))?$translate_11[$lang]['message']:' ' !!}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <textarea name="offline_order_accept_message[]" class="form-control"
                                            placeholder="{{translate('messages.Ex : Your_offline_payment_is_accepted')}}">{!! (isset($translate_12) && isset($translate_12[$lang]))?$translate_12[$lang]['message']:' ' !!}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <textarea name="offline_order_deny_message[]" class="form-control"
                                            placeholder="{{translate('messages.Ex : Your_offline_payment_is_dened')}}">{!! (isset($translate_13) && isset($translate_13[$lang]))?$translate_13[$lang]['message']:' ' !!}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="mb-20">
                                <div class="text-center">
                                    <img src="{{asset('/public/assets/admin/img/email-templates/3.png')}}" alt=""
                                        class="mb-20">
                                    <h5 class="modal-title">{{translate('Write_a_message_in_the_Notification_Body')}}
                                    </h5>
                                </div>
                                <p>
                                    {{
                                ...
                                <div class="btn-wrap">
                                    <button type="submit" class="btn btn--primary w-100" data-dismiss="modal"
                                        data-toggle="modal" data-target="#firebase-modal-2">{{translate('Got
                                        It')}}</button>
                                </div>
                            </div>
                        </div>
