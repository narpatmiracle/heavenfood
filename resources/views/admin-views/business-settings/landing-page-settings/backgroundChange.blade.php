                ...
                <form action="{{ route('admin.business-settings.landing-page-settings', 'backgroundChange') }}"
                    ...
                    <div class="row text-center gy-3">
                        <div class="col-sm-4">
                            ...
                            <input name="header-bg" type="color" class="form-control form-control-color" value="{{ isset($backgroundChange['header-bg']) ? $backgroundChange['header-bg'] : '#d62828' }}">
                        </div>
                        <div class="col-sm-4">
                ...
                <form action="{{ route('admin.business-settings.landing-page-settings', 'background-change') }}"
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <input name="header-bg" type="color" class="form-control form-control-color" value="{{ isset($backgroundChange['primary_1_hex']) ? $backgroundChange['primary_1_hex'] : '#d62828' }}" required>
                        </div>
                        <div class="col-sm-6">
