            ...
            <form action="{{ route('admin.business-settings.landing-page-settings', 'text') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="header_title_1" name="header_title_1" class="form-control h--45px"
                        value="{{ isset($landing_page_text) ? $landing_page_text['header_title_1'] : '' }}" placeholder="{{ translate('Ex: Heavenfood App') }}">
                </div>
                <div class="form-group">
                    ...
                    <input type="text" id="header_title_2" name="header_title_2" class="form-control h--45px"
                        value="{{ isset($landing_page_text) ? $landing_page_text['header_title_2'] : '' }}" placeholder="{{ translate('Ex: Why stay hungry when you can order from Heavenfood') }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="about_title" name="about_title" class="form-control h--45px"
                        value="{{ isset($landing_page_text) ? $landing_page_text['about_title'] : '' }}" placeholder="{{ translate('Ex: Heavenfood is Best Delivery Service Near You') }}">
                </div>
                <div class="form-group">
