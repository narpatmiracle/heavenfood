    ...
    <div class="content container-fluid">
                ...
                <div class="row g-3">
                    <div class="col-md-6 col-sm-6 col-12">
                        <div class="form-group m-0">
                            <form
                                action="{{ route('admin.business-settings.toggle-settings', ['popular_food', $popular_food ? 0 : 1, 'popular_food']) }}"
                                id="popular_food_form" method="get">
                                <label
                    ...
                    <div class="col-md-6 col-sm-6 col-12">
                        <div class="form-group m-0">
                            <form
                                action="{{ route('admin.business-settings.toggle-settings', ['popular_restaurant', $popular_restaurant ? 0 : 1, 'popular_restaurant']) }}"
                                id="popular_restaurant_form" method="get">
                                <label
                                    class="toggle-switch toggle-switch-sm d-flex justify-content-between border rounded px-3 px-xl-4 form-control">
                    ...
                    <div class="col-md-6 col-sm-6 col-12">
                        <div class="form-group m-0">
                            <form
                                action="{{ route('admin.business-settings.toggle-settings', ['new_restaurant', $new_restaurant ? 0 : 1, 'new_restaurant']) }}"
                                id="new_restaurant_form" method="get">
                                <label
                                    class="toggle-switch toggle-switch-sm d-flex justify-content-between border rounded px-3 px-xl-4 form-control">
                                    ...
                                    <input type="checkbox" class="toggle-switch-input" id="new_restaurant"
                    ...
                    <div class="col-md-6 col-sm-6 col-12">
                        <div class="form-group m-0">
                            <form
                                action="{{ route('admin.business-settings.toggle-settings', ['most_reviewed_foods', $most_reviewed_foods ? 0 : 1, 'most_reviewed_foods']) }}"
                                id="most_reviewed_foods_form" method="get">
                                <label
                                    class="toggle-switch toggle-switch-sm d-flex justify-content-between border rounded px-3 px-xl-4 form-control">
        ...
        <form action="{{ route('admin.business-settings.app-settings') }}" method="post" enctype="multipart/form-data">
            ...
            <h5 class="card-title mb-3 pt-3">
                ...
                <span>{{ translate('User_App_Version_Control') }}</span>
            </h5>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row g-3">
                            ...
                            <div class="__bg-F8F9FC-card">
                                <div class="form-group">
                                    <label class="form-label">
                                        {{ translate('messages.Minimum_User_App_Version_for_Force_Update') }}
                                    ...
                                    <input type="number" placeholder="{{ translate('messages.app_minimum_version') }}"
                                        class="form-control h--45px" name="app_minimum_version_android" step="0.001"
                                        min="0"
                                        value="{{ env('APP_MODE') != 'demo' ? $app_minimum_version_android ?? '' : '' }}">
                                </div>
                                <div class="form-group mb-md-0">
                                    <label class="form-label">
                                        {{ translate('messages.Download_URL_for_User_App') }}
                                        ({{ translate('messages.android') }})
                                        <span class="input-label-secondary text--title" data-toggle="tooltip"
                                            data-placement="right"
                                    ...
                                    <input type="text" placeholder="{{ translate('messages.Download_Url') }}"
                                        class="form-control h--45px" name="app_url_android"
                        ...
                        <div class="col-md-6">
                            <h5 class="card-title mb-3">
                                <img src="{{ asset('/public/assets/admin/img/apple.png') }}" class="mr-2"
                                    alt="">
                                {{ translate('For_iOS') }}
                            </h5>
                            <div class="__bg-F8F9FC-card">
                                <div class="form-group">
                                    <label
                                        class="form-label">{{ translate('messages.Minimum_User_App_Version_for_Force_Update') }}
                                    ...
                                    <input type="number" placeholder="{{ translate('messages.app_minimum_version') }}"
                                        class="form-control h--45px" name="app_minimum_version_ios" step="0.001"
                                        min="0"
                                ...
                                <div class="form-group mb-md-0">
                                    ...
                                    <input type="text" placeholder="{{ translate('messages.Download_Url') }}"
                                        class="form-control h--45px" name="app_url_ios"
        ...
        <form action="{{ route('admin.business-settings.app-settings') }}" method="post" enctype="multipart/form-data">
            ...
            <h5 class="card-title mb-3 pt-4">
                <span class="card-header-icon mr-2"><i class="tio-settings-outlined"></i></span>
                <span>{{ translate('Restaurant_App_Version_Control') }}</span>
            </h5>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <div class="__bg-F8F9FC-card">
                                <div class="form-group">
                                    <label
                                        class="form-label text-capitalize">{{ translate('messages.Minimum_Restaurant_App_Version_for_Force_Update') }}
                                        ({{ translate('messages.android') }})
                                        <span class="input-label-secondary text--title" data-toggle="tooltip"
                                            data-placement="right"
                                    ...
                                    <input type="number" placeholder="{{ translate('messages.app_minimum_version') }}"
                                        class="form-control h--45px" name="app_minimum_version_android_restaurant"
                                        step="0.001" min="0"
                                        value="{{ env('APP_MODE') != 'demo' ? $app_minimum_version_android_restaurant ?? '' : '' }}">
                                </div>
                                <div class="form-group mb-md-0">
                                    <label class="form-label text-capitalize">
                                        {{ translate('messages.Download_URL_for_Restaurant_App') }}
                                        ({{ translate('messages.android') }})
                                        <span class="input-label-secondary text--title" data-toggle="tooltip"
                                            data-placement="right"
                                    ...
                                    <input type="text" placeholder="{{ translate('messages.Download_Url') }}"
                                        class="form-control h--45px" name="app_url_android_restaurant"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="__bg-F8F9FC-card">
                                <div class="form-group">
                                    ...
                                    <input type="number" placeholder="{{ translate('messages.app_minimum_version') }}"
                                        class="form-control h--45px" name="app_minimum_version_ios_restaurant"
                                        step="0.001" min="0"
                                        value="{{ env('APP_MODE') != 'demo' ? $app_minimum_version_ios_restaurant ?? '' : '' }}">
                                </div>
                                <div class="form-group mb-md-0">
                                    <label class="form-label text-capitalize">
                                        {{ translate('messages.Download_URL_for_Restaurant_App') }}
                                    ...
                                    <input type="text" placeholder="{{ translate('messages.Download_Url') }}"
                                        class="form-control h--45px" name="app_url_ios_restaurant"
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <div class="__bg-F8F9FC-card">
                                <div class="form-group">
                                    <label
                                        class="form-label text-capitalize">{{ translate('messages.Minimum_Deliveryman_App_Version_for_Force_Update') }}
                                        ({{ translate('messages.android') }})
                                        <span class="input-label-secondary text--title" data-toggle="tooltip"
                                            data-placement="right"
                                ...
                                <div class="form-group mb-md-0">
                                    <label class="form-label text-capitalize">
                                        {{ translate('messages.Download_URL_for_Deliveryman_App') }}
                                        ({{ translate('messages.android') }})
                                        <span class="input-label-secondary text--title" data-toggle="tooltip"
                                            data-placement="right"
                        ...
                        <div class="item">
                            <div class="mb-20">
                                <div class="text-center">
                                    <img src="{{ asset('/public/assets/admin/img/app.png') }}" alt=""
                                        class="mb-20">
                                    <h5 class="modal-title">{{ translate('What is App Version ?') }}</h5>
                                </div>
                                <ul>
                                    <li>
                                        {{ translate('This_app_version_defines_the_Restaurant,_Deliveryman,_and_User_app_version_of_Heavenfood.') }}
                                    </li>
                                    <li>
