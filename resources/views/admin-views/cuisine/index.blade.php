                ...
                <table id="columnSearchDatatable"
                    ...
                    @foreach($cuisine as $key=>$cu)
                        <tr>
                            ...
                            @php($img_src =  isset($cu->image) ?  asset('storage/cuisine').'/'.$cu['image'] : asset('public/assets/admin/img/900x400/img2.jpg')  )
                            <td>
                                            ...
                                            <div class="col-md-6 col-lg-12">
                                                <div class="form-group mb-0 text-center">
                                                    ...
                                                    <label class="upload-img-3 m-0 d-block my-auto">
                                                        <div class="img">
                                                            <img src="{{ asset('storage/cuisine').'/'.$cu['image']  }}"
            ...
            <div class="card-footer pt-0 border-0">
                <div class="page-area px-4 pb-3">
                    <div class="d-flex align-items-center justify-content-end">
                        <div>
                            {{-- {!! $cuisine->links() !!} --}}
                        {!! $cuisine->appends(request()->query())->links('pagination::bootstrap-4') !!}
