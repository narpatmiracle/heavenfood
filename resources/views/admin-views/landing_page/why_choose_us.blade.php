                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="position-relative">
                                ...
                                <label class="upload-img-3 m-0 d-block my-auto">
                                    <div class="img">
                                        <img src="{{asset('storage/why_choose_us_image')}}/{{$data_1_image?->value}}" onerror="this.src='{{asset("/public/assets/admin/img/upload-5.png")}}'" class="vertical-img max-w-555px" alt="">
                                    </div>
                    ...
                    <div class="max-w-555px">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="position-relative">
                                ...
                                <label class="upload-img-3 m-0 d-block my-auto">
                                    <div class="img">
                                        <img src="{{asset('storage/why_choose_us_image')}}/{{$data_2_image?->value}}" onerror="this.src='{{asset("/public/assets/admin/img/upload-5.png")}}'" class="vertical-img max-w-555px" alt="">
                                    </div>
                                    <input type="file" name="image" hidden="">
                                </label>
                    ...
                    <div class="max-w-555px">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="position-relative">
                                ...
                                <label class="upload-img-3 m-0 d-block my-auto">
                                    <div class="img">
                                        <img src="{{asset('storage/why_choose_us_image')}}/{{$data_3_image?->value}}" onerror="this.src='{{asset("/public/assets/admin/img/upload-5.png")}}'" class="vertical-img max-w-555px" alt="">
                                    </div>
                                    <input type="file" name="image" hidden="">
                                </label>
                    ...
                    <div class="max-w-555px">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="position-relative">
                                ...
                                <label class="upload-img-3 m-0 d-block my-auto">
                                    <div class="img">
                                        <img src="{{asset('storage/why_choose_us_image')}}/{{$data_4_image?->value}}" onerror="this.src='{{asset("/public/assets/admin/img/upload-5.png")}}'" class="vertical-img max-w-555px" alt="">
                                    </div>
                                    <input type="file" name="image" hidden="">
                                </label>
