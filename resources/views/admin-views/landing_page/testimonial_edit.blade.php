                                ...
                                <div class="d-flex gap-40px">
                                    <div>
                                        ...
                                        <label class="upload-img-3 m-0 d-block">
                                            <div class="img">
                                                <img src="{{asset('storage/reviewer_image')}}/{{$review->reviewer_image}}"onerror="this.src='{{asset("/public/assets/admin/img/aspect-1.png")}}'" class="vertical-img max-w-187px" alt="">
                                            </div>
                                    ...
                                    {{-- <div class="d-flex flex-column">
                                        ...
                                        <label class="upload-img-3 m-0 d-block my-auto">
                                            <div class="img">
                                                <img src="{{asset('storage/reviewer_image')}}/{{$review->company_image}}" onerror="this.src='{{asset("/public/assets/admin/img/aspect-3-1.png")}}'" class="vertical-img max-w-187px" alt="">
                                            </div>
