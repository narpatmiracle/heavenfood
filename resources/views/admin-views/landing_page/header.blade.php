                                ...
                                <label class="form-label d-block mb-2">
                                    ...
                                    <div class="position-relative">
                                        <label class="upload-img-3 m-0 d-block">
                                                <div class="img">
                                                    <img src="{{asset('storage/header_image')}}/{{ $image_content['header_content_image'] ?? null }}" onerror="this.src='{{asset("/public/assets/admin/img/upload-6.png")}}'" alt="" class="vertical-img max-w-187px">
                                                </div>
                            ...
                            <div class="d-flex flex-column">
                                <div>
                                    ...
                                    <div class="position-relative d-inline-block">
                                        <label class="upload-img-3 m-0 d-block ">
                                            <div class="img">
                                                <img src="{{asset('storage/header_image')}}/{{ $image_content['header_bg_image'] ?? null }}" onerror="this.src='{{asset("/public/assets/admin/img/upload-6.png")}}'" class="vertical-img max-w-187px" alt="">
                                            </div>
