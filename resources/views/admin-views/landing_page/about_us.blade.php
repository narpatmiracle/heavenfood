                                ...
                                <div class="position-relative">
                                    <label class="upload-img-3 m-0 d-block">
                                        <div class="img">
                                            ...
                                            <img src="{{asset('storage/about_us_image')}}/{{ $about_us_content_image ?? null }}" onerror="this.src='{{asset("/public/assets/admin/img/upload-6.png")}}'" class="vertical-img max-w-187px" alt="">
                                        </div>
