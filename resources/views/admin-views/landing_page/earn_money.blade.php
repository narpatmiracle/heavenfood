                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="position-relative">
                                ...
                                <label class="upload-img-3 m-0 d-block my-auto">
                                    <div class="img">
                                        <img src="{{asset('storage/earn_money')}}/{{ $earn_money_reg_image?->getRawOriginal('value') ?? null }}" onerror="this.src='{{asset("/public/assets/admin/img/upload-3.png")}}'" class="img__aspect-unset mw-100 min-w-187px" alt="">
                                    </div>
