                            ...
                            <div class="col-12">
                                <div class="swiper mySwiper pb-3">
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="d-flex flex-column align-items-center mx-w450 mx-auto">
                                                <img src="{{ asset('public/assets/admin/img/slider-3.png') }}"
                        ...
                        <div class="col-12">
                            @if ($condition_one && $condition_two)
                                <div class="d-flex justify-content-end mt-3">
                                    <button type="button" onclick="zip_upload()" class="btn btn--primary px-4"
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body px-4 px-sm-5 text-center">
                                                    ...
                                                    <div class="btn--container justify-content-center">
                                                        ...
                                                        <button type="submit" class="btn btn--cancel min-w-120"
                                                            data-dismiss="modal"
