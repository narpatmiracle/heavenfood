                                ...
                                <div class="col-md-6">
                                    <div class="form-group h-100 mb-0 d-flex flex-column">
                                        ...
                                        <center class="my-auto">
                                            <img class="initial-2" id="viewer" onerror="this.src='{{asset('public/assets/admin/img/900x400/img1.jpg')}}'" src="{{asset('storage/banner')}}/{{$banner['image']}}" alt="campaign image"/>
                                        </center>
                                        <div class="form-group">
