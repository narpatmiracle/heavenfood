                ...
                <div class="d-flex flex-wrap justify-content-between align-items-center">
                    <div class="page--header-title">
                        ...
                        <p class="page-header-text">
                            {{ translate('messages.Hello,_here_you_can_manage_your_orders_by_zone.') }}</p>
                    </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-header align-items-center">
                            <h5 class="card-title">
                                <img src="{{ asset('/public/assets/admin/img/dashboard/statistics.png') }}" alt="dashboard"
                                    ...
                                    <div class="ml-auto mb-2 pb-xl-5">
                                        <select class="custom-select" name="user_overview"
                                            ...
                                            <option value="overall"
                                                {{ $params['user_overview'] == 'overall' ? 'selected' : '' }}>
                ...
                <div class="row align-items-center">
                    <div class="col-sm mb-2 mb-sm-0">
                        <h1 class="page-header-title">{{ translate('messages.welcome') }},
                            {{ auth('admin')->user()->f_name }}.</h1>
                        <p class="page-header-text">
                            {{ translate('messages.Hello,_here_you_can_manage_your_restaurants.') }}</p>
                    </div>
                </div>
            </div>
            <!-- End Page Header -->
