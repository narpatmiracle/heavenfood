            ...
            <div class="navbar-vertical-content bg--title" id="navbar-vertical-content">
                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        @if (\App\CentralLogics\Helpers::module_permission_check('customer_wallet'))
                            <li
                                ...
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                    href="javascript:" title="{{ translate('messages.Customer_Wallet') }}">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        ...
                                        <a class="nav-link "
                                            href="{{ route('admin.customer.wallet.bonus.add-new') }}"
                                            title="{{ translate('messages.bonus') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span
                                                class="text-truncate text-capitalize">{{ translate('messages.bonus') }}</span>
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('settings'))
                        ...
                        <!-- Subscription-->
                        @if (
                            \App\CentralLogics\Helpers::subscription_check() == true &&
                            ...
                            <li
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('admin/subscription/list') ? 'active' : '' }}">
                                        <a class="nav-link "
