...
?>
  ...
  <div style="width:595px;margin:auto; background-color:white;
      ...
      <span style="font-weight: 400;font-size: 14px;line-height: 135.5%;color: #182E4B;display:block; margin-bottom:34px;">{{translate('A_request_has_been_received_to_change_password_for_your')}} <span style="color: #d62828;">{{$company_name}}</span> {{translate('account')}}. <br> {{translate('Your_password_reset_token_is')}}:</span>
      <span style="font-weight: 400;font-size: 12px;line-height: 135.5%;color: #5D6774; display:block; margin-bottom:82px;">
        <span style="background: #d62828;color: white;padding: 10px;font-size: large;border: 3px solid #d62828;border-radius: 10px;">{{$token}} </span>
      </span>
