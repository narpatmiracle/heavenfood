                ...
                <div class="card-header py-3 bg-transparent">
                    <h5 class="card-title my-1 text--primary">
                        <span class="card-header-icon">
                            <i class="fa fa fa-store" style="color: #d72828;"></i>
                        </span>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="latitude" name="latitude" class="form-control"
                                    placeholder="{{ translate('messages.Ex :') }} 4.22213" value="4.22213" required readonly>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="longitude" class="form-control" placeholder="{{ translate('messages.Ex :') }} 103.344322"
                                    id="longitude" value="4.22213" required readonly>
                            </div>
                        </div>
                    </div>
