                ...
                <div class="page-header">
                    <div class="d-flex flex-wrap justify-content-between align-items-center">
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            <a href="{{route('vendor.shop.edit')}}" class="btn btn-outline-danger"><i class="tio-open-in-new"></i> {{translate('Edit_Shop')}} </a>
                        </div>
                    </div>
                </div>
                <!-- End Page Header -->
                ...
                <section class="shop-details-banner">
                    <div class="card">
                        <div class="card-body px-0 pt-0">
                            <img src="{{asset('storage/restaurant/cover/'.$shop->cover_photo)}}"  onerror="this.src='{{asset('public/assets/admin/img/900x400/img1.jpg')}}'"class="shop-details-banner-img" alt="">
                            <div class="shop-details-banner-content">
                                <div class="shop-details-banner-content-thumbnail">
                                    <img src="{{asset('storage/restaurant/'.$shop->logo)}}"  onerror="this.src='{{asset('public/assets/admin/img/160x160/img1.jpg')}}'" class="thumbnail" alt="">
