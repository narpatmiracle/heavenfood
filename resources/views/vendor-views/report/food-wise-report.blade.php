                ...
                <form method="get">
                    <div class="row g-3">
                        ...
                        <div class="col-sm-6 col-md-3">
                            ...
                            <!-- Veg/NonVeg filter -->
                            <select name="type" onchange="set_filter('{{ url()->full() }}',this.value, 'type')"
                                data-placeholder="{{ translate('messages.select_type') }}"
                                class="form-control js-select2-custom">
                                <option value="all" {{ $type == 'all' ? 'selected' : '' }}>
                                    {{ translate('messages.all_types') }}</option>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive datatable-custom" id="table-div">
                            ...
                            <div class="page-area px-4 pb-3">
                                {{-- {!! $foods->links() !!} --}}
                {!! $foods->appends(request()->query())->links('pagination::bootstrap-4') !!}
