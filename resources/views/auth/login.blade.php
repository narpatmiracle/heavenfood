...
<head>
    ...
    @endphp
    <!-- Title -->
    <title>{{ translate('messages.login') }} | {{ $app_name ?? translate('Heavenfood') }}</title>
    ...
    <main id="content" role="main" class="main auth-bg">
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-between">
            <div class="auth-content">
                <div class="content">
                    <h2 class="title text-uppercase">{{ translate('messages.welcome_to_app') }}
                        {{ $app_name ?? 'Heavenfood' }}</h2>
                    <p>
            ...
            <div class="auth-wrapper">
                <div class="auth-wrapper-body auth-form-appear">
                    ...
                    <a class="auth-logo mb-5" href="javascript:">
                        <img class="z-index-2"
                            onerror="this.src='{{ asset('/public/assets/admin/img/auth-fav.png') }}'"
                            @if (isset($systemlogo)) src="{{ asset('storage/business/' . $systemlogo->value) }}"
                        @else
                        src="{{ asset('/public/assets/admin/img/auth-fav.png') }}" @endif>
                    </a>
